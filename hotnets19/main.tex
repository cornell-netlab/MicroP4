...
Packet-processing target devices, with programmable parsers and re-configurable match-action tables primitives and P4, a language based on the primitives to program the devices, together have enabled unprecedented programmability.
This ecosystem has exposed architectural details of targets' data planes along with heterogeneous abstract-machines based on the primitives, in the programming model.
This has led to P4 programs being target-specific and consist of complex abstract-machine, thereby, making it difficult to reuse P4 code for developing new programs and deploying on other targets.
...
We present the design of $\mu$P4 along with proof-of-concept implementation that allows to express sequential-execution of multiple programs and generate a real target-specific code.
