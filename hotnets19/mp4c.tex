...
% The architectures of real target devices specify target-specific externs, pipeline model and constraints on programmable blocks in their pipelines.
% For example, v1model provides recirculate, resubmit and clone to route the packet in pipeline across different processing blocks.
% It does not allow to set or modify output port in egress control block for the packet the pipeline.


% \subsubsection{Execution Schedule}
% \subsubsection{Intrinsic Metadata Constraints}
% \subsubsection{Intrinsic Metadata Constraints}
