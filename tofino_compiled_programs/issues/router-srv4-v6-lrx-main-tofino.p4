...
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s1[1].data", 8,8)
...
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[13].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[29].data", 8,8)
#if __TARGET_TOFINO__ == 2
@pa_container_type ("ingress", "mpkt.msa_hdr_stack_s1[1].data", "normal")
@pa_container_type ("ingress", "mpkt.msa_hdr_stack_s0[7].data", "normal")
@pa_container_type ("ingress", "mpkt.msa_hdr_stack_s0[9].data", "normal")
...
@pa_container_type ("ingress", "mpkt.msa_hdr_stack_s0[13].data", "normal")
@pa_container_type ("ingress", "mpkt.msa_hdr_stack_s0[29].data", "normal")
#endif
...
control SRv4_micro_parser(inout msa_packet_struct_t p, out sr4_hdr_t hdr, out SRv4_parser_meta_t parser_meta) {
    ...
    action i_272_start_0() {
        ...
        hdr.option.useless = p.msa_hdr_stack_s0[17].data[15:13];
        hdr.option.option_num = p.msa_hdr_stack_s0[17].data[12:8];
        hdr.option.len = p.msa_hdr_stack_s0[17].data[7:0];
        hdr.option.data_pointer = p.msa_hdr_stack_s0[18].data[15:8];
        hdr.option.padding = p.msa_hdr_stack_s0[18].data[7:0];
    }
    ...
    table parser_tbl {
        key = {
            p.indices.curr_offset            : exact;
            p.msa_hdr_stack_s0[17].data[12:8]: ternary;
        }
        actions = {
            i_272_start_0();
        ...
        const entries = {
                        (16w272, 5w0x3) : i_272_parse_src_routing_0();

                        (16w272, 5w0x9) : i_272_parse_src_routing_1();
...
control SRv4_micro_control(inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout sr4_hdr_t hdr, out bit<16> nh) {
    ...
    @name("SRv4.micro_control.sr4_tbl") table sr4_tbl_0 {
        ...
        const entries = {
                        (5w0x3, 32w0xa000256, default, default, default, default, default) : set_nexthop_addr2();

                        (5w0x3, default, 32w0xa000256, default, default, default, default) : set_nexthop_addr3();

                        (5w0x3, default, default, 32w0xa000256, default, default, default) : set_nexthop_addr4();

                        (5w0x3, default, default, default, 32w0xa000256, default, default) : set_nexthop_addr5();

                        (5w0x3, default, default, default, default, 32w0xa000256, default) : set_nexthop_addr6();

                        (5w0x3, 32w0xa000256, default, default, default, default, default) : set_nexthop(32w0xa000256);

                        (5w0x3, default, 32w0xa000256, default, default, default, default) : set_nexthop(32w0xa000256);

                        (5w0x3, default, default, 32w0xa000256, default, default, default) : set_nexthop(32w0xa000256);
                        ...
                        (5w0x9, 32w0xa000256, default, default, default, default, default) : set_nexthop_addr2();

                        (5w0x9, default, 32w0xa000256, default, default, default, default) : set_nexthop_addr3();

                        (5w0x9, default, default, 32w0xa000256, default, default, default) : set_nexthop_addr4();

                        (5w0x9, default, default, default, 32w0xa000256, default, default) : set_nexthop_addr5();

                        (5w0x9, default, default, default, default, 32w0xa000256, default) : set_nexthop_addr6();

                        (5w0x9, default, default, default, default, default, default) : drop_action();
...
control MplsLR_micro_deparser(inout msa_packet_struct_t p, in mpls_hdr_t hdr, in MplsLR_parser_meta_t parser_meta, in MplsLR_hdr_vop_t hdr_vop) {
    ...
    action move_14_8_48() {
        p.msa_hdr_stack_s1[2].data = p.msa_hdr_stack_s0[30].data;
        p.msa_hdr_stack_s1[1].data = p.msa_hdr_stack_s0[29].data;
        p.msa_hdr_stack_s1[0].data = p.msa_hdr_stack_s0[28].data;
        p.msa_hdr_stack_s0[31].data = p.msa_hdr_stack_s0[27].data;
