...
/*
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[7].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[8].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[9].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[10].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[11].data", 8,8)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[12].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[13].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[14].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[15].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[16].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[17].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[18].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[19].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[20].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[21].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[22].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[23].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[24].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[25].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[26].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[27].data", 16)
@pa_container_size ("ingress", "mpkt.msa_hdr_stack_s0[28].data", 16)
*/
@pa_atomic ("ingress", "mpkt.msa_hdr_stack_s0[10].data")
struct msa_packet_struct_t {
    csa_indices_h      indices;
    msa_byte_h         msa_byte;
    msa_twobytes_h[29] msa_hdr_stack_s0;
}
...
struct MplsLSR_parser_meta_t {
    bool   mpls0_v;
    bool   mpls1_v;
    bit<1> packet_reject;
}

struct MplsLSR_hdr_vop_t {
    bool mpls1_sv;
    bool mpls1_siv;
    bool mpls0_sv;
    bool mpls0_siv;
...
@pa_atomic ("ingress", "ipv6.nexthdr")
struct ipv6_h {
    bit<4>   version;
    bit<8>   class;
    bit<20>  label;
...
control L3v6_micro_deparser(inout msa_packet_struct_t p, in l3v6_hdr_t h, in L3v6_parser_meta_t parser_meta) {
    ...
    bit<2> f = 2w0;
    action ipv6_14_54_0() {
        p.msa_hdr_stack_s0[10].data[15:12] = h.ipv6.nexthdr[7:4] ;
        f =2w1;
    }
    action ipv6_14_54_1() {
        p.msa_hdr_stack_s0[10].data[11:9] = h.ipv6.nexthdr[3:1] ;
        f =2w2;
    }
    action ipv6_14_54_2() {
        p.msa_hdr_stack_s0[10].data[8:8] = h.ipv6.nexthdr[0:0] ;
        f =2w3;
    }
    action ipv6_14_54_3() {
        p.msa_hdr_stack_s0[11].data[7:0] = h.ipv6.hoplimit;
    }


    action ipv6_14_54() {
        p.msa_hdr_stack_s0[10].data[7:0] = h.ipv6.hoplimit;
    ...
    table deparser_tbl_0 {
        ...
        const entries = {
                        (16w112, true) : ipv6_14_54_0();

        }

        const default_action = NoAction();
    }
    table deparser_tbl_1 {
        key = {
            f : exact;
        }
        actions = {
    ...
    apply {
        deparser_tbl.apply();
/*
        deparser_tbl_0.apply();
        deparser_tbl_1.apply();
        deparser_tbl_2.apply();
        deparser_tbl_3.apply();
*/
    }
}
...
control MplsLSR_micro_parser(inout msa_packet_struct_t p, out mpls_hdr_t hdr, out MplsLSR_parser_meta_t parser_meta) {
    action micro_parser_init() {
    ...
    action i_112_start_0() {
        ...
        hdr.mpls0.label = p.msa_hdr_stack_s0[7].data ++ p.msa_hdr_stack_s0[8].data[15:12];
        hdr.mpls0.exp = p.msa_hdr_stack_s0[8].data[11:9];
        hdr.mpls0.bos = p.msa_hdr_stack_s0[8].data[8:8];
        hdr.mpls0.ttl = p.msa_hdr_stack_s0[8].data[7:0];
    }
    action i_112_parse_mpls1_0() {
        parser_meta.mpls1_v = true;
        hdr.mpls1.label = p.msa_hdr_stack_s0[9].data ++ p.msa_hdr_stack_s0[10].data[15:12];
        hdr.mpls1.exp = p.msa_hdr_stack_s0[10].data[11:9];
        hdr.mpls1.bos = p.msa_hdr_stack_s0[10].data[8:8];
        hdr.mpls1.ttl = p.msa_hdr_stack_s0[10].data[7:0];
        parser_meta.mpls0_v = true;
        hdr.mpls0.label = p.msa_hdr_stack_s0[7].data ++ p.msa_hdr_stack_s0[8].data[15:12];
        hdr.mpls0.exp = p.msa_hdr_stack_s0[8].data[11:9];
        hdr.mpls0.bos = p.msa_hdr_stack_s0[8].data[8:8];
    ...
    table parser_tbl {
        key = {
            p.indices.curr_offset          : exact;
            p.msa_hdr_stack_s0[8].data[8:8]: ternary;
        }
        actions = {
            i_112_start_0();
            i_112_parse_mpls1_0();
        ...
        const entries = {
                        (16w112, 1w0) : i_112_parse_mpls1_0();
...
control MplsLSR_micro_control(inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout mpls_hdr_t hdr, inout mpls_meta_t m, out bit<16> nextHop, out MplsLSR_hdr_vop_t hdr_vop) {
    @name(".NoAction") action NoAction_0() {
    }
    @name("MplsLSR.micro_control.drop_action") action drop_action() {
        ig_intr_md_for_dprsr.drop_ctl = 3w0x1;
    }
    @name("MplsLSR.micro_control.encap1") action encap1() {
        m.ethType = 16w0x8847;
        ...
        hdr.mpls0.label = 20w0x400;
        hdr.mpls0.ttl = 8w32;
        hdr.mpls1.bos = 1w0;
        nextHop = 16w10;
    }
    @name("MplsLSR.micro_control.encap0") action encap0() {
        m.ethType = 16w0x8847;
    ...
    @name("MplsLSR.micro_control.decap") action decap() {
        m.ethType = 16w0x800;
        hdr_vop.mpls0_sv = false;
        hdr_vop.mpls0_siv = true;
        nextHop = 16w10;
    }
    @name("MplsLSR.micro_control.replace") action replace() {
        hdr.mpls0.ttl = hdr.mpls0.ttl + 8w255;
        nextHop = 16w10;
    }
    @name("MplsLSR.micro_control.mpls_tbl") table mpls_tbl_0 {
        key = {
            hdr.mpls0.ttl  : ternary @name("hdr.mpls0.ttl") ;
            hdr.mpls0.label: ternary @name("hdr.mpls0.label") ;
        }
        actions = {
            drop_action();
            encap0();
...
control MplsLSR_micro_deparser(inout msa_packet_struct_t p, in mpls_hdr_t hdr, in MplsLSR_parser_meta_t parser_meta, in MplsLSR_hdr_vop_t hdr_vop) {
  
    bit<2> e8_l0 = 2w0;
    bit<2> e8_l1 = 2w0;
    bit<2> e10_l1 = 2w0;

    action e8_l0_w_15_12() {
        p.msa_hdr_stack_s0[8].data[15:12] = hdr.mpls0.label[3:0];
        e8_l0 = 2w1;
    }
    action e8_l0_w_11_9() {
        p.msa_hdr_stack_s0[8].data[11:9] = hdr.mpls0.exp;
        e8_l0 = 2w2;
    }
    action e8_l0_w_8_8() {
        p.msa_hdr_stack_s0[8].data[8:8] = hdr.mpls0.bos;
        e8_l0 = 2w3;
    }
    action e8_l0_w_7_0() {
        p.msa_hdr_stack_s0[8].data[7:0] = hdr.mpls0.ttl;
    }

    action e8_l1_w_15_12() {
        p.msa_hdr_stack_s0[8].data[15:12] = hdr.mpls1.label[3:0];
        e8_l1 = 2w1;
    }
    action e8_l1_w_11_9() {
        p.msa_hdr_stack_s0[8].data[11:9] = hdr.mpls1.exp;
        e8_l1 = 2w2;
    }
    action e8_l1_w_8_8() {
        p.msa_hdr_stack_s0[8].data[8:8] = hdr.mpls1.bos;
        e8_l1 = 2w3;
    }
    action e8_l1_w_7_0() {
        p.msa_hdr_stack_s0[8].data[7:0] = hdr.mpls1.ttl;
    }

    action e10_l1_w_15_12() {
        p.msa_hdr_stack_s0[10].data[15:12] = hdr.mpls1.label[3:0];
        e10_l1 = 2w1;
    }
    action e10_l1_w_11_9() {
        p.msa_hdr_stack_s0[10].data[11:9] = hdr.mpls1.exp;
        e10_l1 = 2w2;
    }
    action e10_l1_w_8_8() {
        p.msa_hdr_stack_s0[10].data[8:8] = hdr.mpls1.bos;
        e10_l1 = 2w3;
    }
    action e10_l1_w_7_0() {
        p.msa_hdr_stack_s0[10].data[7:0] = hdr.mpls1.ttl;
    }


    action mpls0_14_18() {
        p.msa_hdr_stack_s0[7].data = hdr.mpls0.label[19:4];
        e8_l0_w_15_12();
        // p.msa_hdr_stack_s0[8].data = hdr.mpls0.label[3:0] ++ hdr.mpls0.exp ++ hdr.mpls0.bos ++ hdr.mpls0.ttl;
    }


    action mpls1_14_18() {
        p.msa_hdr_stack_s0[7].data = hdr.mpls1.label[19:4];
        e8_l1_w_15_12();
        // p.msa_hdr_stack_s0[8].data = hdr.mpls1.label[3:0] ++ hdr.mpls1.exp ++ hdr.mpls1.bos ++ hdr.mpls1.ttl;
    }
    action mpls1_18_22() {
        p.msa_hdr_stack_s0[9].data = hdr.mpls1.label[19:4];
        e10_l1_w_15_12();
        // p.msa_hdr_stack_s0[10].data = hdr.mpls1.label[3:0] ++ hdr.mpls1.exp ++ hdr.mpls1.bos ++ hdr.mpls1.ttl;
    }
    action move_14_4_40() {
    ...
    action mpls0_14_18_MO_Emit_4() {
        move_14_4_40();
        mpls0_14_18();
    }
    action mpls0_14_18_MO_Emit_mi0() {
        mpls0_14_18();
    }
    action move_14_4_4() {
    }
    ...
    action mpls0_14_18_mpls1_14_18_MO_Emit_4() {
        move_18_4_36();
        move_14_4_4();
        mpls1_18_22();
        mpls0_14_18();
    }
    action mpls0_14_18_mpls1_18_22_MO_Emit_mi0() {
        mpls1_18_22();
        mpls0_14_18();
    }
    action mpls1_14_18_MO_Emit_4() {
        move_14_4_40();
        mpls1_14_18();
    }
    action mpls0_14_18_mpls1_18_22_MO_Emit_4() {
        move_18_4_36();
        mpls1_18_22();
        mpls0_14_18();
    }
    action mpls1_14_18_MO_Emit_mi0() {
        mpls1_14_18();
    }
    action MO_Emit_mi0() {
    }
    action move_18_mi4_40() {
    ...
    action move_18_mi4_4() {
    }
    action mpls1_18_22_MO_Emit_mi4() {
        move_18_mi4_4();
        mpls1_14_18();
        move_22_mi4_36();
    }
    table deparser_tbl {
        ...
        actions = {
            mpls0_14_18();
            move_14_4_40();
            mpls0_14_18_MO_Emit_4();
            mpls0_14_18_MO_Emit_mi0();
            mpls1_18_22();
            move_14_4_4();
            move_18_4_36();
            mpls0_14_18_mpls1_14_18_MO_Emit_4();
            mpls0_14_18_mpls1_18_22_MO_Emit_mi0();
            mpls1_14_18();
            mpls1_14_18_MO_Emit_4();
            mpls0_14_18_mpls1_18_22_MO_Emit_4();
            mpls1_14_18_MO_Emit_mi0();
            MO_Emit_mi0();
            move_18_mi4_40();
            MO_Emit_mi4();
            move_22_mi4_36();
            move_18_mi4_4();
            mpls1_18_22_MO_Emit_mi4();
            NoAction();
        }
        const entries = {
                        (16w112, false, false, false, true, false) : mpls0_14_18_MO_Emit_4();

                        (16w112, true, false, false, true, false) : mpls0_14_18_MO_Emit_mi0();

                        (16w112, false, true, false, true, false) : mpls0_14_18_mpls1_14_18_MO_Emit_4();

                        (16w112, true, true, false, true, false) : mpls0_14_18_mpls1_18_22_MO_Emit_mi0();

                        (16w112, false, false, true, false, false) : mpls1_14_18_MO_Emit_4();

                        (16w112, true, false, true, false, false) : mpls0_14_18_mpls1_18_22_MO_Emit_4();

                        (16w112, false, true, true, false, false) : mpls1_14_18_MO_Emit_mi0();

                        (16w112, true, true, true, false, false) : mpls0_14_18_mpls1_18_22_MO_Emit_mi0();

                        (16w112, false, false, false, false, true) : MO_Emit_mi0();

                        (16w112, true, false, false, false, true) : MO_Emit_mi4();

                        (16w112, false, true, false, false, true) : mpls1_14_18_MO_Emit_mi0();

                        (16w112, true, true, false, false, true) : mpls1_18_22_MO_Emit_mi4();
    ...
    table t0 {
      ...
      const entries = {
         (2w1, 2w0, 2w0) : e8_l0_w_11_9();
         (2w0, 2w1, 2w0) : e8_l1_w_11_9();
         (2w0, 2w0, 2w1) : e10_l1_w_11_9();
      }
    }
    table t1 {
      key = {
      ...
      const entries = {
         (2w2, 2w0, 2w0) : e8_l0_w_8_8();
         (2w0, 2w2, 2w0) : e8_l1_w_8_8();
         (2w0, 2w0, 2w2) : e10_l1_w_8_8();
      }
    }
    table t2 {
      key = {
      ...
      const entries = {
         (2w3, 2w0, 2w0) : e8_l0_w_7_0();
         (2w0, 2w3, 2w0) : e8_l1_w_7_0();
         (2w0, 2w0, 2w3) : e10_l1_w_7_0();
      }
    }
...
control MplsLSR(inout msa_packet_struct_t msa_packet_struct_t_var, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, out bit<16> out_param) {
    MplsLSR_micro_parser() MplsLSR_micro_parser_inst;
    MplsLSR_micro_control() MplsLSR_micro_control_inst;
    MplsLSR_micro_deparser() MplsLSR_micro_deparser_inst;
    mpls_hdr_t mpls_hdr_t_var;
    mpls_meta_t mpls_meta_t_var;
    MplsLSR_parser_meta_t MplsLSR_parser_meta_t_var;
    MplsLSR_hdr_vop_t MplsLSR_hdr_vop_t_var;
    apply {
        MplsLSR_micro_parser_inst.apply(msa_packet_struct_t_var, mpls_hdr_t_var, MplsLSR_parser_meta_t_var);
        MplsLSR_micro_control_inst.apply(ig_intr_md_for_dprsr, mpls_hdr_t_var, mpls_meta_t_var, out_param, MplsLSR_hdr_vop_t_var);
        MplsLSR_micro_deparser_inst.apply(msa_packet_struct_t_var, mpls_hdr_t_var, MplsLSR_parser_meta_t_var, MplsLSR_hdr_vop_t_var);
    }
}
...
control MPRouter_micro_control(inout msa_packet_struct_t msa_packet_struct_t_var, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm, inout hdr_t hdr) {
    ...
    @name("MPRouter.micro_control.mpls_i") MplsLSR() mpls_i_0;
    ...
    apply {
        ...
        if (hdr.eth.ethType == 16w0x800) 
            ...
            if (hdr.eth.ethType == 16w0x86dd) 
                ...
                if (hdr.eth.ethType == 16w0x8847) 
                    mpls_i_0.apply(msa_packet_struct_t_var, ig_intr_md_for_dprsr, nh_0);
        forward_tbl_0.apply();
    }
}
