...
control Vlan_micro_control(inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm, inout vlan_hdr_t hdr, inout vlan_meta_t m, out Vlan_hdr_vop_t hdr_vop) {
...
control Vlan_micro_deparser(inout msa_packet_struct_t p, in vlan_hdr_t hdr, in Vlan_parser_meta_t parser_meta, in Vlan_hdr_vop_t hdr_vop) {
    ...
    table deparser_tbl {
        ...
        const entries = {
                        (16w112, false, true) : MO_Emit_mi0();

                        (16w112, true, true) : MO_Emit_mi4();
...
control Vlan(inout msa_packet_struct_t msa_packet_struct_t_var, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm, inout bit<16> inout_param) {
    ...
    apply {
        ...
        Vlan_micro_control_inst.apply(ig_intr_md_for_dprsr, ig_intr_md_for_tm, vlan_hdr_t_var, vlan_meta_t_var, Vlan_hdr_vop_t_var);
...
control ModularVlan_micro_control(inout msa_packet_struct_t msa_packet_struct_t_var, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm, inout hdr_t hdr) {
    @name(".NoAction") action NoAction_0() {
    }
    bit<16> nh_0;
    ...
    apply {
        ...
        if (hdr.eth.ethType == 16w0x8100) 
            vlan_0.apply(msa_packet_struct_t_var, ig_intr_md_for_dprsr, ig_intr_md_for_tm, hdr.eth.ethType);
        if (hdr.eth.ethType == 16w0x800) 
            l3v4_i_0.apply(msa_packet_struct_t_var, nh_0, hdr.eth.ethType);
        else 
            if (hdr.eth.ethType == 16w0x86dd) 
                l3v6_i_0.apply(msa_packet_struct_t_var, nh_0, hdr.eth.ethType);
        forward_tbl_0.apply();
    }
}
...
control ModularVlan(inout msa_packet_struct_t msa_packet_struct_t_var, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm) {
    ...
    apply {
        ...
        ModularVlan_micro_control_inst.apply(msa_packet_struct_t_var, ig_intr_md_for_dprsr, ig_intr_md_for_tm, hdr_t_var);
...
control msa_tofino_ig_control(inout msa_packet_struct_t mpkt, inout msa_user_metadata_t msa_um, in ingress_intrinsic_metadata_t ig_intr_md, in ingress_intrinsic_metadata_from_parser_t ig_intr_md_from_prsr, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm) {
    ...
    apply {
        ModularVlan_inst.apply(mpkt, ig_intr_md_for_dprsr, ig_intr_md_for_tm);
    }
}
