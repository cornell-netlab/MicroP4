...
parser ParserImpl (packet_in pin, out filter_hdr_t parsed_hdr, 
...
control ingress(inout filter_hdr_t parsed_hdr, inout filter_meta_t meta,
                 inout standard_metadata_t standard_metadata) {	
                         action drop_action() {
            meta.drop_flag = 1;
        }
...
control egress(inout filter_hdr_t parsed_hdr, inout filter_meta_t meta,
                 inout standard_metadata_t standard_metadata) {	
...
control DeparserImpl(packet_out packet, in  filter_hdr_t hdr) {
    apply {
...
control verifyChecksum(inout  filter_hdr_t hdr, inout filter_meta_t meta) {
    apply {
    }
}

control computeChecksum(inout  filter_hdr_t hdr, inout filter_meta_t meta) {
    apply {
    }
}
