...
struct routerv4_hdr_t {
  ethernet_h ethernet;
  ipv4_h ipv4;
}

parser ParserImpl (packet_in pin, out routerv4_hdr_t parsed_hdr, 
                inout routerv4_meta_t meta, 
...
control egress(inout routerv4_hdr_t parsed_hdr, inout routerv4_meta_t meta,
                 inout standard_metadata_t standard_metadata) {	
     action drop_action() {
   		 meta.drop_flag = 1;
    }
...
control ingress(inout routerv4_hdr_t parsed_hdr, inout routerv4_meta_t meta,
                 inout standard_metadata_t standard_metadata) {	
...
control DeparserImpl(packet_out packet, in  routerv4_hdr_t hdr) {
    apply {
...
control verifyChecksum(inout  routerv4_hdr_t hdr, inout routerv4_meta_t meta) {
    apply {
    }
}

control computeChecksum(inout  routerv4_hdr_t hdr, inout routerv4_meta_t meta) {
    apply {
    }
}
