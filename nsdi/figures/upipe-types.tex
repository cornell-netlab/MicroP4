...
\node () at (-1,-1) [minimum height=0.5cm, color=gray, text centered, text width=1em,anchor=east] {buffer};
\node () at (8,-1) [minimum height=0.5cm, color=gray, text centered, text width=1em,anchor=east] {buffer};
