...
the pipeline. In order to raise the level of abstraction for packet
processing in dataplane pipeline, \upipelines comprise of \emph{only programmable
packet-processing blocks} such as parser, match-action control blocks and
