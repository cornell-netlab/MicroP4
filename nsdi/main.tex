...
It maps the control blocks to the ones declared by pipeline node of 
the target while translating \uarch-specific constructs to the 
target architecture-specific ones.
