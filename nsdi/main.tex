...
Our main goal is to make dataplane programs portable, modular, and
composable.
...
architectures.
\tightpar{Modular:} Individual dataplane functionality could be
...
be composed together in custom ways to express more complex
dataplanes.
