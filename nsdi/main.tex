...
Essentially, current ecosystem not only creates tight coupling between architectures and programs but also delegates responsibility of P4 code allocation to appropriate packet-processing unit to programmers.

To enable easy reuse of code, it is mandatory $(1)$ to have higher level of abstraction for data plane pipeline in architectures and $(2)$ to unify abstract-machines for various packet-processing phase.


\section{MicroP4}

\hse{TODO: overview }
\subsection*{Compiling MicroP4 Programs}
