...
implement the same architecture, it also creates a tight coupling
between:
...
\texttt{ether.up4} in \cref{fig:compile-module} performs only
...
in \cref{fig:compile-to-target}, \texttt{main.up4} composes
...
!{\subcaption[]{l3.up4 implements IPv4 and IPv6}\label{subfig:router}}!
/* !{modular\_router.up4}! uses L3 program */
...
\tightpar{Example: Modular router using \texttt{Unicast} interface and
  externs.} \cref{subfig:router} shows a program, \texttt{l3.up4},
