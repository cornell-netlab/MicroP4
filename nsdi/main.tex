...
% (... and modularity)
\paragraph{2. P4 programs are monolithic.}
P4's programming model introduces unnecessary tight coupling among
pieces of the program which could be kept independent. For example, in
