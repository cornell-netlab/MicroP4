...
(PISA)~\cite{psa} models a switch with a
...
deparser (Figure \ref{fig:psa-model}). 
PISA programs supply P4 code for each programmable block.
P4 also allows to specify target-specific features and data as a part of the target's architecture declaration.
PISA programs can use features and data specific to the architecture in the code for programmable block.
