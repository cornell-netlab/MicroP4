...
metadata \texttt{im}. \texttt{ModularRouter} (in
\cref{subfig:router-main})
declares an additional parameter, \texttt{type}. Such user-define
parameters allow to pass data across \upackages, providing great
...
(shown below).
\begin{lstlisting}[frame=none, escapechar=!]
control mc(pkt p, hdr_t h, es_t e, 
