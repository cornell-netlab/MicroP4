...
\begin{figure}[tbh]
  ...
  \label{fig:workflow}
\end{figure}
\tightparbf{Midend} passes perform transformations for two goals. \par
...
constructs. 
\tightparbf{Backend} passes transform the \ucomp-IR to the IR of a 
...
% We perform recursive analysis to extract-length and byte-stack size 
% of a \uprogram. 
