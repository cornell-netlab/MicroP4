...
example, \texttt{L2.\ulang} in \cref{fig:compile-module} performs only
ethernet processing similar to \cref{fig:l2.p4}.
...
\cref{fig:compile-to-target}, \texttt{main.\ulang} composes L2 and L3
