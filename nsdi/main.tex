...
the pipeline and  $(3)$ target-specific constructs.
These dependencies pose multiple challenges to reuse P4 programs
...
\paragraph{Challenge 2: High coupling of programmable blocks 
...
independently}
there is no uniform or compatible interface \deleted{that programmers 
can use}
