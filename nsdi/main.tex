...
$\mu$SA captures such constraints using stateful extern objects capturing dependency among correlated intrinsic metadata.
$\mu$SA declares \texttt{es\_t} as an extern object.
...
The \texttt{es\_t} extern declares a two-arguments method, \texttt{get\_value}.
