...
The workflow with \ulang is very simple and intuitive. Users write
dataplane programs using an extended P4 language which supports
modularity and composition. These programs are written with the \uarch
architecture. While compiling, users specify the real target
architecture to which the \ulang programs should be mapped to. This
decouples programs from target architectures.
...
\subcaption[]{Main \uprogram}\label{subfig:router-main}
\end{minipage}
