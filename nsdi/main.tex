...
We briefly highlight important constructs in our proposal with
reference to P4-16 specification. \ulang allows defining custom
package types that enable hiding the implementation of a
packet-processing function and exposing an interface to reuse the
code.
