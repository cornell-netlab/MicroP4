...
\begin{lstlisting}[frame=none, escapechar=!]
0x86DD : {
   !\colorbox{mygray}{srv6\_i.apply(p, sm, es);}! // copies next segment address from h.sr to h.ipv6.destAddr 
  ipv6_i.apply(p, sm, es, nh_id);
}
\end{lstlisting}
...
Another, example code fragment below shows implementation of \texttt{A-B Testing} composition operator defined by P4Visor\cite{Zheng:2018:PLV:3281411.3281436}.
\begin{lstlisting}[frame=none, escapechar=!]
