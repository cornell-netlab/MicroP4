...
control L3v4_micro_parser(inout msa_packet_struct_t p, out l3_hdr_t hdr, inout bit<16> ethType, out L3v4_parser_meta_t parser_meta) {
...
control L3v4_micro_control(inout l3_hdr_t hdr, out bit<16> nexthop) {
...
control L3v4_micro_deparser(inout msa_packet_struct_t p, in l3_hdr_t h, in L3v4_parser_meta_t parser_meta) {
    action ipv4_14_30() {
...
control L3v4(inout msa_packet_struct_t msa_packet_struct_t_var, out bit<16> out_param, inout bit<16> inout_param) {
    ...
    apply {
        L3v4_micro_parser_inst.apply(msa_packet_struct_t_var, l3_hdr_t_var, inout_param, L3v4_parser_meta_t_var);
        L3v4_micro_control_inst.apply(l3_hdr_t_var, out_param);
        L3v4_micro_deparser_inst.apply(msa_packet_struct_t_var, l3_hdr_t_var, L3v4_parser_meta_t_var);
    }
}
